...
const char * const PIVX_CONF_FILENAME = "btca.conf";
const char * const PIVX_PID_FILENAME = "btca.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\btca
// Windows >= Vista: C:\Users\Username\AppData\Roaming\btca
// Mac: ~/Library/Application Support/btca
// Unix: ~/.btca
#ifdef WIN32
    // Windows
