...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTCA features */
        {"btca", "listmasternodes", &listmasternodes, true },
        {"btca", "getmasternodecount", &getmasternodecount, true },
        {"btca", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"btca", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"btca", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"btca", "masternodecurrent", &masternodecurrent, true },
        {"btca", "startmasternode", &startmasternode, true },
        {"btca", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"btca", "createmasternodekey", &createmasternodekey, true },
        {"btca", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"btca", "listmasternodeconf", &listmasternodeconf, true },
        {"btca", "getactivemasternodecount", &getactivemasternodecount, true },
        {"btca", "getmasternodestatus", &getmasternodestatus, true },
        {"btca", "getmasternodewinners", &getmasternodewinners, true },
        {"btca", "getmasternodescores", &getmasternodescores, true },
        {"btca", "mnsync", &mnsync, true },
        {"btca", "spork", &spork, true },
        {"btca", "mnping", &mnping, true },
