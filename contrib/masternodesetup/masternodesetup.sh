...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='btca.conf'
CONFIGFOLDER='/root/.btca'
COIN_DAEMON='btcad'
COIN_CLI='btca-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/bitcoinadditional/BTCA/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
