...
#define MyAppName "BTCa Core"
#define MyAppPublisher "2022 Bitcoin Additional Core Developers"
#define MyAppURL "https://btcadd.io"
#define MyAppExeName "btca-qt.exe"
#define MyAppExtraData "https://explorer.bitcoinadditional.net/bootstraps/BTCA/bootstrap.zip"
...
[Files]
Source: ".\package\btca-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\BTCa\BTCa-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\BTCa\BTCa-Qt,strDataDir|{userappdata}\BTCa\}');
  Result := True;
end;
