...
btca.conf           | contains configuration settings for btcad or btca-qt
btcad.pid           | stores the process id of btcad while running
...
debug.log           | contains debug information and general logging generated by btcad or btca-qt
