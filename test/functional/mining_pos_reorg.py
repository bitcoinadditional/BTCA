...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected BTCA supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check BTCA supply at the beginning
        # ------------------------------------------
        # BTCA supply: block rewards minus burned fees for minting
        ...
        # Verify that BTCA supplies were properly updated after the spends and reorgs
        self.log.info("Check BTCA supply...")
