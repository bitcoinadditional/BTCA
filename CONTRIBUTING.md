Contributing to BTCa Core
============================

The BTCa Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BTCa Core project, and is not to be
confused with overall BTCa Network Protocol consensus changes.

Whether a pull request is merged into BTCa Core rests with the project merge
...
Where a patchset proposes to change the BTCa consensus, it must have been
...
The project leader is the release manager for each BTCa Core release.
